...
async def start_command(client: Client, message: Message):
    ...
    if id == owner_id:
        ...
        if "verify_" in message.text:
            ...
            SD = await message.reply_text("Hi! Files will be deleted After 10 minutes. DUE TO SAFETY PURPOSE !")
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                TUT_VID = f"https://t.me/Darkvideoshere/5432"
                ...
                await message.reply(f"Your Ads token is expired, refresh your token and try again.\n\nToken Timeout: {get_exp_time(VERIFY_EXPIRE)}\n\nWhat is the token?\n\nThis is an ads token. If you pass 1 ad, you can use the bot for 12 Hour & watch unlimited videos after passing the ad.", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
